<template>
  <div class="s-colors">
    ...
    >
      <div v-for="color in colorGroup" :key="color.color" class="side-by-side">
        ...
        <div>
          <span class="name color-code" @click="handleCopy(color.name)">{{
            color.name
          }}</span>
          <span class="hex color-code" @click="handleCopy(color.hex)">{{
            color.hex
          }}</span>
        </div>
      </div>
